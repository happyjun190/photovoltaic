...
/**
 * 获取API URL的根，比如http://api.bowu.cn/photovoltaic
 */
function getApiRoot(){
	return getRootPath();
}
 ...
 * });
 * 
 * @Param: url绝对路径或相对路径，比如http://locolhost:8080/photovoltaic/servlet/login 或 /servlet/login
...
/**
 * 获取项目根路径，如： http://localhost:8083/photovoltaic
 */
function getRootPath() {
	//获取当前网址，如： http://localhost:8083/photovoltaic/web/index.html
	var curWwwPath = window.document.location.href;
	//获取主机地址之后的目录，如：photovoltaic/web/index.html
	var pathName = window.document.location.pathname;
	var pos = curWwwPath.indexOf(pathName);
	//获取主机地址，如： http://localhost:8083
	var localhostPath = curWwwPath.substring(0, pos);
	//获取带"/"的项目名，如：/photovoltaic
